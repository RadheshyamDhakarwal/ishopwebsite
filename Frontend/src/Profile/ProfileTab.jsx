    ...
    return (
        <div className="border-b mb-3 max-w-[1100px] mx-auto border-gray-200 dark:border-gray-700">
            <ul className="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-700">
                <li className="me-2">
                    <Link to="/User-Profile" className={`inline-flex items-center justify-center p-4 ${pathname == "/User-Profile" ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 ' : ''} `}>
                        <svg className={`w-4 h-4  me-2  ${pathname == "/User-Profile" ? 'text-blue-600  border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 ' : ''} `} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                ...
                <li className="me-2">
                    <Link to="/User-Profile/my-Orders " className={`inline-flex items-center justify-center p-4 ${pathname == "/profile/my-Orders" ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 ' : ''} `}>
                        <svg className={`w-4 h-4  me-2  ${pathname == "/User-Profile/my-Orders" ? 'text-blue-600  border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 ' : ''} `} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                ...
                <li className="me-2 ">
                    <Link to="/User-Profile/change-password " className={`inline-flex items-center justify-center p-4 ${pathname == "/User-Profile/change-password" ? 'text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 ' : ''} `}>
