                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={singUpHandler} >
                                ...
                                <button
                                    type="submit"
                                    className="w-full text-white bg-[#007D88] hover:bg-[#007D88] focus:ring-4 focus:outline-none focus:ring-[#007D88] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#007D88] dark:hover:bg-[#007D88] "
                                >
                                    Create an account
                                </button>
