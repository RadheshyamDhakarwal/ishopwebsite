                    ...
                    <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                                <label for="newsletter" className="font-light text-gray-500 dark:text-gray-300">I accept the
                                    <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a>
                                </label>
                            </div>
                        </div>
                        <button type="submit" className="w-full text-white bg-[#007D88] hover:bg-[#007D88] focus:ring-4 focus:outline-none focus:ring-[#007D88] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#007D88] dark:hover:bg-[#007D88] ">Reset passwod</button>
