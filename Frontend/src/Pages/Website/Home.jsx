...
const Home = () => {
    ...
    return (
        <>
            ...
            {/* <div className="container justify-center lg:justify-between gap-[20px]  ">
                            ...
                            (slider, index) => (
                                <div key={index} className=' '>
                                    <div className='flex'>
                                        ...
                                        <div className=''>
                                            <h1 className='font-bold '>{slider.title}</h1>
                                            <h1>⭐⭐⭐⭐</h1>
                                        </div>
                                    </div>
                                </div>
                                // <Slider key={index} title={slider.title} img={slider.img} />
                            )
                        )
                    }
                </Slider>
